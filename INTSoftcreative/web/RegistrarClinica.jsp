<%-- 
    Document   : RegistrarClinica
    Created on : 4/03/2020, 09:44:46 PM
    Author     : pao_o
--%>
    ...
    <head>
     ...
     <body>
        <header class="container rounded-lg" style="background: rgba(0,0,0,0.5);">
            <h1 class="display-4">Registrar Clínica</h1>
        </header>
            ...
            <table class="table table-hover table-success border-white rounded-lg">
                ...
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <input class="btn btn-outline-success margin-bottom" type="button" id="btnCalcular" value="Registarse">
                    </td>
                </tr>
            </table>
        </div>

<%-- 
    Document   : EliminarClinica
    Created on : 4/03/2020, 10:08:34 PM
    Author     : pao_o
--%>
    ...
    <head>
       ...
       <body>
        <header class="container rounded-lg" style="background: rgba(0,0,0,0.5);">
            <h1 class="display-4">Eliminar Clínica</h1>
        </header>
        ...
        <div class="container">
            <table class="table table-hover table-info border-white rounded-lg" id="tabla">
                ...
                <tr class="table-success">
                    ...
                    <td id="bdtelefono"></td>
                    <td id="bdestatus"></td>     
                    <td> <input class="btn btn-outline-success margin-bottom" type="button" id="btnCalcular" value="Eliminar"></td>
                </tr>
                </tbody>
